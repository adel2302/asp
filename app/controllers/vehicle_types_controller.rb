  ...
  def create
    ...
    respond_to do |format|
      if @vehicle_type.save
        format.html { redirect_to vehicle_types_url, notice: 'Vehicle type was successfully created.' }
        format.json { render :index, status: :created, location: @vehicle_types }
      else
  ...
  def update
    respond_to do |format|
      if @vehicle_type.update(vehicle_type_params)
        format.html { redirect_to vehicle_types_url, notice: 'Vehicle type was successfully updated.' }
        format.json { render :index, status: :ok, location: @vehicle_types }
      else
