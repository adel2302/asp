...
class AvailabilitiesControllerTest < ActionController::TestCase
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post :create, availability: { date: @availability.date, driver_id: @availability.driver_id, hour_end: @availability.hour_end, hour_start: @availability.hour_start }
    end
  ...
  test "should update availability" do
    patch :update, id: @availability, availability: { date: @availability.date, driver_id: @availability.driver_id, hour_end: @availability.hour_end, hour_start: @availability.hour_start }
    assert_redirected_to availability_path(assigns(:availability))
  end
